...
public class CapitaleGenerator extends Generator {

    public static final int MAX_SIZE = 197;

    /**
     * constructeur
     * 
     * @param nuberQuestions
     */
    public CapitaleGenerator(Quizz myQuizz, int nuberQuestions) {
	super(myQuizz, nuberQuestions);
    }

    /**
     * Retourne la liste complète des questions/réponses du quizz capitale
     */
